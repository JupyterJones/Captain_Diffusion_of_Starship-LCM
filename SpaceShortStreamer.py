...
current_prompt = "Highly detailed Centered Science fiction image of a star-gate with semi transparent space creatures swimming in space similar to mythical sea monsters, surrounded with space, stars, planets, nebula, dust and space debris <lora:more_details:.8>, 8k resolution, dramatic clouds in the atmosphere"
...
def load_state():
    ...
    try:
        ...
        with state_lock:
            ...
            default_steps = int(state.get("steps", 10))
            default_cfg = float(state.get("cfg", 1.4))
...
def generate_story():
    try:
        ...
        if not files:
            return jsonify({"error": "No generated frames found in static/streamer/ to process."}), 400
...
def teleport():
    ...
    try:
        ...
        # Save locally in the output/streamer folder
            ...
            <div class="panel-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="cfg" step="0.1" oninput="updateConfigField('cfg', parseFloat(this.value) || 0)">
                    </div>
                </div>
...
def compile_story_movie():
    ...
    if not wav_files:
        return "No narration WAV files found in static/streamer/. Please generate your story first.", 400
