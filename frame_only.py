...
def add_title_image(video_path, hex_color="#A52A2A"):
    ...
    title_image_path = "/home/jack/Desktop/Captain_Diffusion_of_Starship-LCM/static/port-cap.png"
    ...
    if not composite_clip.audio:
        ...
        mp3_files = glob.glob("/home/jack/Desktop/mp3/*.mp3")
    ...
    uid = str(randint(1111111,9999999))
    output_path = f'temp/{uid}final_output3.mp4'
